      ...
      <div className="container px-4 mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="space-y-4">
            <Badge variant="outline" className="px-4 py-1 text-primary border-primary/20 bg-primary/5 rounded-full font-medium">
            ...
            <p className="text-lg text-muted-foreground max-w-xl leading-relaxed">
              8+ years of expertise delivering high-performance eCommerce platforms, 
              headless commerce solutions, and enterprise-grade customer experiences 
              with React, Next.js, and Dynamics 365.
            </p>
          </div>

          <div className="flex flex-wrap gap-4">
            <Button size="lg" className="rounded-full bg-primary text-primary-foreground font-semibold px-8 hover:scale-105 transition-transform group">
              Download Resume
              <FileText className="ml-2 h-4 w-4 transition-transform group-hover:-translate-y-0.5" />
            </Button>
            <Button variant="outline" size="lg" className="rounded-full border-primary/20 hover:bg-primary/5 px-8 font-semibold">
              View Projects
          ...
          <div className="flex items-center gap-6 pt-4">
            ...
            <div className="flex gap-2">
              <Badge variant="secondary" className="bg-secondary/50">Next.js 15</Badge>
              <Badge variant="secondary" className="bg-secondary/50">Dynamics 365</Badge>
              <Badge variant="secondary" className="bg-secondary/50">TypeScript</Badge>
            </div>
          </div>
        </motion.div>
          ...
          <div className="relative w-72 h-72 lg:w-[450px] lg:h-[450px]">
            ...
            >
              <div className="h-10 w-10 bg-accent/20 rounded-xl flex items-center justify-center">
                <Badge variant="outline" className="border-accent/40 text-accent font-bold">D365</Badge>
              </div>
              <div>
